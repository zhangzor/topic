...
import { generateAdditionQuestions } from './mathGenerator.js'
...
const resetQuiz = () => {
  stopTimer()
  additionQuestions.value = generateAdditionQuestions()
...
.pages {
  ...
  padding: 10px;
  min-height: 100vh;
  background-image: url('https://scachealth.oss-cn-shanghai.aliyuncs.com/202410/c44f9c84-8af0-4aae-8a82-bf3d17639f4e.jpeg'); 
