...
import { generateMultiplicationQuestions } from './mathGenerator.js'
...
const resetQuiz = () => {
  stopTimer()
  additionQuestions.value = generateMultiplicationQuestions()
...
.pages {
  ...
  padding: 10px;
  min-height: 100vh;
  background-image: url('https://scachealth.oss-cn-shanghai.aliyuncs.com/202410/228f2b4c-9a84-4e23-880c-73a4b04a9d76.jpeg'); 
