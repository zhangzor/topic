...
import { generatePercentageQuestions } from './mathGenerator.js'
...
const resetQuiz = () => {
  stopTimer()
  additionQuestions.value = generatePercentageQuestions()
...
.pages {
  ...
  padding: 10px;
  min-height: 100vh;
  background-image: url('https://scachealth.oss-cn-shanghai.aliyuncs.com/202410/cf583189-f781-4938-84bf-38d0bd96605b.jpeg'); 
