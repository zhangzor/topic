...
import { generateDivisionQuestions } from './mathGenerator.js'
...
const resetQuiz = () => {
  stopTimer()
  additionQuestions.value = generateDivisionQuestions()
...
.pages {
  ...
  padding: 10px;
  min-height: 100vh;
  background-image: url('https://scachealth.oss-cn-shanghai.aliyuncs.com/202410/9dd1122b-d6c0-4a8f-827f-b0430371c2df.jpeg'); 
